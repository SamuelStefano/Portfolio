    ...
    <section id="sobre" className="scroll-mt-20 py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24 px-4 sm:px-6 lg:px-8 bg-muted/20" ref={containerRef}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16 items-start xl:items-center">
          <div className="space-y-6 sm:space-y-7 md:space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 animate-slide-left mx-2 sm:mx-6">
              ...
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <Text variant="small" className="text-xs sm:text-sm">{t('about.education')}</Text>
              </div>
              <div className="flex items-center gap-2 text-muted-foreground">
          ...
          {/* Educar+ and the hackathon stage */}
          <div className="mt-8 sm:mt-10 md:mt-12 lg:mt-16 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-6 lg:gap-10 items-center rounded-xl md:rounded-2xl border border-primary/20 bg-gradient-to-r from-neon-purple/10 via-primary/5 to-neon-cyan/10 p-4 sm:p-6 lg:p-8 lg:hover-slide-scale transition-all duration-300">
              <div className="animate-slide-right">
                <div className="flex items-center gap-3 mb-4">
                  <img src="/EducarMais.webp" alt="Instituto Educar+" className="h-10 w-auto object-contain" loading="lazy" />
                  <Heading level={3} className="from-primary to-neon-purple bg-gradient-to-r bg-clip-text text-transparent text-lg sm:text-xl lg:text-2xl leading-tight">
                    {t('about.educar.title')}
                  </Heading>
                </div>
