        ...
        <div id="experiencia" className="animate-fade-up scroll-mt-24">
          ...
          <div id="empresas" className="flex flex-wrap justify-center items-center gap-8 lg:gap-16 py-6 mb-12 scroll-mt-24">
            {[
              ...
              { src: '/Itera-wordmark.png', alt: 'Itera',           cls: 'w-32 h-20', href: 'https://iterahq.dev/' },
          ...
          <div className="max-w-3xl mx-auto relative">
            ...
            <div className="space-y-10">
              {EXPERIENCE_DATA.map((job, i) => {
                const localizedHighlights = t(`experience.items.${job.key}.highlights`, {
                  returnObjects: true,
                  defaultValue: [],
                }) as unknown;
                const highlights = Array.isArray(localizedHighlights) ? (localizedHighlights as string[]) : [];
                  ...
                  >
                    ...
                    {job.website ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group flex-1 bg-card border border-border rounded-xl p-5 hover-card transition-all duration-300 block"
                      >
                        <ExperienceItem
                          company={job.company}
